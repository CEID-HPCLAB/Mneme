...
class ParStandardScaler(StandardScaler):
    ...
    def __init__(self, num_idxs: List[str], data_file: str = None, copy: Optional[bool] = True, 
                 with_mean: Optional[bool] = True, with_std: Optional[bool] = True) -> None:
    
        super(ParStandardScaler, self).__init__(copy = copy, with_mean = with_mean, with_std = with_std)
    ...
    def process_chunk(self, chunk_data: pl.DataFrame) -> None:
        ...
        scaler.with_mean = self.with_mean; scaler.with_std = self.with_std
    ...
    def fit(self, block_reader: Union[Optional[BlockReader], None] = None, 
        ...
        if num_workers == 1 and IO_workers == 1:
            ...
            t2 = time()
            _Mneme_logger.benchmark(f"Sequential Standalone StandardScaler Time -> Fit: {t1-t0:.6f} | Reduce: {t2-t1:.6f}")
            ...
            t2 = time()
            _Mneme_logger.benchmark(f"Parallel Standalone StandardScaler Time -> Fit: {t1-t0:.6f} | Reduce: {t2-t1:.6f}")
